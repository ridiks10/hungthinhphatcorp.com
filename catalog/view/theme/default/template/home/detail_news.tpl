...
<div>
    ...
    <div id='news_page_content'>
        <div class="wrapper">
            ...
            <h3 style="margin-bottom: 10px">Phát hành số liệu dự án</h3>

            <img id='news_bg_image' alt='' src="catalog/view/theme/default/fre/images/news/news4_full.jpg">
            
            <div class="justify">
                <div class="news_date">
                    <span class="news_img_date font_awesome"></span>
                    <span class='news_text_date'>26.08.2016 20:54</span>
                </div>
                <div class="news_date"> <!--
                    <span class="news_img_date font_awesome"></span>
                    <span class='news_text_date'>279 lượt xem</span>-->
                </div>
            </div>

            <div style="margin-top: 30px">
                Các số liệu về dự án được phát hành trên trang chính và được cập nhật ở chế độ trực tuyến.  
            </div>
